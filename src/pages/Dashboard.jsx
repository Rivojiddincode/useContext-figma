...
<div className='flex flex-col'>
    <p style={{color: theme === "light"? "black": "#fff"}} className='text-[20px] text-[#ffff] font-medium'>Jane Daniel</p>
    <span style={{color: theme === "light"? "black": "#fff"}} className='text-[14px] text-[#FFFFFF] font-light'>Agent</span>
</div>
</div>
<button className='w-30.5 h-11.5 bg-[#499BFC] rounded-md text-[16px] text-[#FFFFFF] font-normal cursor-pointer'>Edit Profile</button>
    ...
    {/* pas */}
    <div style={{background: theme === "dark" ? "#1A1D1F" : "#ccc"}} className='flex flex-col gap-8 w-full p-8 h-140.25 bg-[#1A1D1F] rounded-[10px]'>
